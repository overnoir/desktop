export default {
  ...
  settings: {
    ...
    update: {
      description: "Actualice la aplicación a la última versión.",
      title: "Actualización",
      button: "Actualizar",
      alreadyLatest: "La aplicación ya está en la última versión.",
    },
  },
  vault: {
  ...
  discord: {
    connect: {
      description:
        "Conéctese para ver la actividad del canal de voz en la superposición.",
      clientId: {
        description: "¿Cómo puedo obtener un Client ID?",
        placeholder: "ID de Cliente de la Aplicación",
      },
