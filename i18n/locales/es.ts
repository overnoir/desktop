export default {
  ...
  settings: {
    ...
    alignment: {
      description:
        "Elija la alineación de la superposición.",
      title: "Alineación",
      right: "Derecha/Abajo",
    ...
    gap: {
      title: "Espaciado",
      description:
        "Ajuste el espaciado entre los elementos.",
    },
    showBackground: {
    ...
    opacity: {
      description:
        "Ajuste el nivel de transparencia de la superposición.",
      title: "Opacidad",
    },
    radius: {
      description:
        "Ajuste el redondeo de las esquinas de la superposición.",
    ...
    alwaysOnTop: {
      description:
        "Mantenga la aplicación siempre en primer plano.",
  ...
  vault: {
    ...
    clear: {
      ...
      dialog: {
        ...
        title:
          "Eliminar todos los datos de la caja fuerte",
        confirm: "Sí, eliminar",
        cancel: "Cancelar",
      },
    },
  ...
  discord: {
    ...
    disconnect: {
      ...
      dialog: {
        ...
        deleteVaultItems:
          "Eliminar los datos del token de la caja fuerte",
    ...
    showGuildIconAnimated: {
      description:
        "Elija si el icono del servidor aparece animado.",
      title: "Animación del Icono del Servidor",
    },
    showMe: {
      description:
        "Elija si aparece usted en la superposición.",
      title: "Mostrarme",
    },
    showMutedUsers: {
      description:
    ...
    showBots: {
      description:
        "Elija si los bots aparecen en la superposición.",
      title: "Mostrar Bots",
    },
    showSpeakersOnly: {
      description:
        "Mostrar solo los usuarios que están hablando.",
    ...
    showDisplayName: {
      description:
        "Elija cuándo aparece el nombre de usuario.",
      title: "Visualización del Nombre",
    },
    showAvatarAnimated: {
      description:
        "Elija cuándo aparece el avatar animado.",
      title: "Animación del Avatar",
    },
    displayName: {
      description:
        "Elija qué nombre mostrar para los usuarios.",
  ...
  kick: {
    addChannel: {
      alreadyAdded:
        "Este nombre de usuario ya está en la lista.",
      invalid:
    ...
    showOnlyLive: {
      description:
        "Mostrar solo los streamers que están en directo.",
      title: "Mostrar Solo en Directo",
    },
    showDisplayName: {
      description:
        "Elija cuándo aparece el nombre del streamer.",
      title: "Visualización del Nombre",
    },
    displayName: {
      description:
        "Elija qué nombre mostrar para los streamers.",
      title: "Nombre a Mostrar",
      slug: "Slug del Canal",
    ...
    showCategory: {
      description:
        "Elija cuándo aparece la categoría del stream.",
      title: "Mostrar Categoría del Stream",
    },
    streamerLimit: {
      description:
        "Elija el número máximo de streamers a mostrar.",
